...
- [references/api-mapping.md](../../references/api-mapping.md) — Android → OpenHarmony 完整 API 映射表
- [refs/taskpool.md](../../references/refs/taskpool.md) — TaskPool 完整 API
- [refs/worker.md](../../references/refs/worker.md) — Worker 完整 API
- [refs/collections.md](../../references/refs/collections.md) — 共享容器 API
- [refs/containers.md](../../references/refs/containers.md) — 线性/非线性容器 API
- [refs/buffer.md](../../references/refs/buffer.md) — Buffer API（替代 ByteBuffer）
- [refs/utils.md](../../references/refs/utils.md) — 工具类 API
- [refs/xml.md](../../references/refs/xml.md) — XML 解析生成 API
